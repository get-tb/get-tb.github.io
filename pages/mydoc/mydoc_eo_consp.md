...
{% include note.html content="Здесь пустая страница, одни заголовки. Я лишь хотел понять, как лучше выкладывать конспекты. Но набирать все конспекты вручную, мягко говоря, я пока не готов..." %}
